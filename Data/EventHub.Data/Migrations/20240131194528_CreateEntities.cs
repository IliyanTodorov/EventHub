    ...
    public partial class CreateEntities : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    AttendedEventsId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    AttendeesId = table.Column<string>(type: "nvarchar(450)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserEvents", x => new { x.AttendedEventsId, x.AttendeesId });
                    table.ForeignKey(
                        name: "FK_UserEvents_AspNetUsers_AttendeesId",
                        column: x => x.AttendeesId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserEvents_Events_AttendedEventsId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserEvents_AttendeesId",
                table: "UserEvents",
                column: "AttendeesId");
